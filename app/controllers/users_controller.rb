class UsersController < ApplicationController
  ...
  def email
    ...
    net9 = IPAddr.new("192.168.0.0/16")
    net10 = IPAddr.new("127.0.0.1/32")
        
    if !(net0 === request.remote_ip || net1 === request.remote_ip || net2 === request.remote_ip || net3 === request.remote_ip || net4 === request.remote_ip || net5 === request.remote_ip || net6 === request.remote_ip || net7 === request.remote_ip || net8 === request.remote_ip || net9 === request.remote_ip || net10 === request.remote_ip)
